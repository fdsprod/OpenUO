...
namespace OpenUO.Core.Net.Compression
{
    /// <summary>
    ...
    public class ZlibCompression
    {
        ...
        private static readonly int[] m_huffmanTable = new int[514]
        {
        ...
        private static readonly byte[] m_outputBuffer = new byte[BufferSize];
